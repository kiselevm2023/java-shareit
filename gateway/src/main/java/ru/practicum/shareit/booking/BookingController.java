...
public class BookingController {
    ...
    public ResponseEntity<Object> createBooking(
            @RequestHeader(HttpConstants.X_SHARER_USER_ID) Long bookerId,
    ...
    public ResponseEntity<Object> approvingBooking(
        ...
        log.info(
                "Patch request /booking approved, data transmitted: {}",
                approved
        );
    ...
    public ResponseEntity<Object> getBookingId(
            @RequestHeader(HttpConstants.X_SHARER_USER_ID) Long userId,
            @PathVariable Long bookingId
    ) {
        log.info(
                "Get request /booking, userId: {},  and bookingId: {} ",
                userId,
                bookingId
        );
    ...
    public ResponseEntity<Object> findUserBookingsWithState(
        ...
        log.info(
                "Get with params state, userId: {}, status: {},  from: {}, size: {}",
                userId,
                status,
                from,
                size
        );
        return bookingClient.findUserBookingsWithState(
                userId,
                status,
                from,
                size
    ...
    public ResponseEntity<Object> findOwnerBookingsWithState(
        ...
        return bookingClient.findOwnerBookingsWithState(
                ownerId,
                status,
                from,
                size
